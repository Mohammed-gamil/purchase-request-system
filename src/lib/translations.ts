export type TranslationKey = 
  ...
  | 'prCreate.errorDescriptionRequired'
  ...
  | 'prDetails.toast.rejectionSuccess'
  | 'prDetails.selected'
  | 'prDetails.selectThisQuote'
  | 'prDetails.selectLowestQuote'
  | 'prDetails.toast.lowestQuoteSelected'
  | 'prDetails.toast.quoteSelected'
  | 'prDetails.mustSelectQuoteBeforeApproval'
  | 'prDetails.goToQuotes'
  | 'prDetails.quoteUrl'
  | 'prDetails.quoteUrlHelp'
...
export const translations: Record<'en' | 'ar', Record<TranslationKey, string>> = {
  ...
  'prCreate.errorDescriptionRequired': 'Description is required',
  ...
  'prDetails.payoutReferenceRequired': 'Payout reference is required',
    'prDetails.toast.rejectionSuccess': 'Rejection submitted successfully',
    'prDetails.selected': 'Selected',
    'prDetails.selectThisQuote': 'Select this quote',
    'prDetails.selectLowestQuote': 'Select lowest quote',
    'prDetails.toast.lowestQuoteSelected': 'Lowest quote selected',
    'prDetails.toast.quoteSelected': 'Quote selected',
    'prDetails.mustSelectQuoteBeforeApproval': 'Please select a quote before final approval',
    'prDetails.goToQuotes': 'Go to Quotes',
    'prDetails.quoteUrl': 'Quote URL',
    'prDetails.quoteUrlHelp': 'Link to an online quote or vendor proposal (optional)',
  ...
  'notifications.approval.message': '{id}: {title} requires your approval',
  ...
  'notifications.rejected.message': '{id}: {title} was rejected',
  ...
  'prCreate.errorDescriptionRequired': 'الوصف مطلوب',
  ...
  'prDetails.toast.rejectionSuccess': 'تم إرسال الرفض بنجاح',
    'prDetails.selected': 'مُحدد',
    'prDetails.selectThisQuote': 'اختر هذا العرض',
    'prDetails.selectLowestQuote': 'اختر أقل عرض',
    'prDetails.toast.lowestQuoteSelected': 'تم اختيار أقل عرض',
    'prDetails.toast.quoteSelected': 'تم اختيار العرض',
    'prDetails.goToQuotes': 'اذهب إلى العروض',
    'prDetails.quoteUrl': 'رابط عرض السعر',
    'prDetails.quoteUrlHelp': 'رابط مباشر إلى عرض السعر عبر الإنترنت (اختياري)',
  ...
  'admin.users.toast.updated': 'تم تحديث المستخدم بنجاح!',
    ...
    'prDetails.mustSelectQuoteBeforeApproval': 'يرجى اختيار عرض سعر قبل الموافقة النهائية',
  },
};